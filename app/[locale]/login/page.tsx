        ...
        <TranslationsProvider resources={resources} locale={locale} namespaces={i18nNamespaces}>
            <main>
                ...
                <div className="flex-1 max-w-2xl w-screen"></div>
                    <div className="z-10 py-20 px-14 flex flex-col items-center w-full max-w-lg p-6 bg-white shadow-lg rounded-xl m-6">
                        <h2 className="text-2xl font-semibold text-gray-900 mb-6">{t("auth:LoginWelcome")}</h2>
                        <LoginForm />
                    </div>
                </div>
            </main>
